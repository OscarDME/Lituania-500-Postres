...
export const copy = {
  ...
  hero: {
    ...
    subheadline:
      "Atrask 500 minkštų, purių ir be galo gardžių pyragų receptų: visiškai be glitimo, laktozės ir cukraus. Mėgaukis kiekvienu kąsneliu be kaltės jausmo ar apribojimų.",
